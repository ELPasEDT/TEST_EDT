...
Процедура ОбновитьСодержаниеЗаписи()
	...
	Комментарий = СтрЗаменить(мШаблон, "#Оборудование", СтрокаОборудования);
	Комментарий = СтрЗаменить(Комментарий, "#Сотрудники", СтрокаСотрудников);
...
Процедура СкорректироватьСоставСтраниц()
	...
	Если СтрНайти(мШаблон, "#Оборудование") Тогда
...
&НаКлиенте
Процедура УстиновитьОтборСпискаСобытий()
	
	ДоступныеСобытия = мФормаДок.ПолучитьСписокСобытий(мСтруктураДанныхДокумента.Реквизиты.ВидЗаписи);
