...
Функция ПолучитьДанныеРегистраНастроек()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаЗначенийПоказателейПГУ.ЗначениеПоказателя КАК ЗначениеПоказателя,
		|	НастройкаЗначенийПоказателейПГУ.Синоним КАК Синоним,
		|	НастройкаЗначенийПоказателейПГУ.ТипЗначения КАК ТипЗначения
		|ИЗ
		|	РегистрСведений.НастройкаЗначенийПоказателейПГУ КАК НастройкаЗначенийПоказателейПГУ
		|ГДЕ
		|	НастройкаЗначенийПоказателейПГУ.Организация = &Организация";
...
Функция ПолучитьДанныеРегистраНастроекШапка()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаЗначенийПоказателейПГУШапка.ЗначениеПоказателя КАК ЗначениеПоказателя,
		|	НастройкаЗначенийПоказателейПГУШапка.Синоним КАК Синоним,
		|	НастройкаЗначенийПоказателейПГУШапка.ТипЗначения КАК ТипЗначения
		|ИЗ
		|	РегистрСведений.НастройкаЗначенийПоказателейПГУШапка КАК НастройкаЗначенийПоказателейПГУШапка
		|ГДЕ
		|	НастройкаЗначенийПоказателейПГУШапка.Организация = &Организация";
...
&НаКлиенте
Процедура ПоказателиШапкиЗначениеПоказателя16НачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	ЗначениеПоказателяШапкаНачалоВыбора(Элемент, 16);
КонецПроцедуры

&НаКлиенте
Процедура ПоказателиШапкиЗначениеПоказателя17НачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	ЗначениеПоказателяШапкаНачалоВыбора(Элемент, 17);
КонецПроцедуры
