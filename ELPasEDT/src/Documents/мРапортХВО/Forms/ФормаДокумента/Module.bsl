...
Функция ПолучитьДанныеРегистраНастроек()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаЗначенийПоказателейХВО.ЗначениеПоказателя КАК ЗначениеПоказателя,
		|	НастройкаЗначенийПоказателейХВО.Синоним КАК Синоним,
		|	НастройкаЗначенийПоказателейХВО.ТипЗначения КАК ТипЗначения
		|ИЗ
		|	РегистрСведений.НастройкаЗначенийПоказателейХВО КАК НастройкаЗначенийПоказателейХВО
		|ГДЕ
		|	НастройкаЗначенийПоказателейХВО.Организация = &Организация";
...
Функция ПолучитьДанныеРегистраНастроекШапка()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаЗначенийПоказателейХВОШапка.ЗначениеПоказателя КАК ЗначениеПоказателя,
		|	НастройкаЗначенийПоказателейХВОШапка.Синоним КАК Синоним,
		|	НастройкаЗначенийПоказателейХВОШапка.ТипЗначения КАК ТипЗначения
		|ИЗ
		|	РегистрСведений.НастройкаЗначенийПоказателейХВОШапка КАК НастройкаЗначенийПоказателейХВОШапка
		|ГДЕ
		|	НастройкаЗначенийПоказателейХВОШапка.Организация = &Организация";
