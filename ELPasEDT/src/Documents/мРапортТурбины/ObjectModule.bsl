...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ШаблонРапортТурбины") Тогда
		...
		Для Каждого ТекСтр Из ДанныеЗаполнения.ДанынеПоТурбинам Цикл
			НовСтр = ДанынеПоТурбинам.Добавить();
