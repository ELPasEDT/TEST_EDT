...
Функция ПолучитьДанныеРегистраНастроек()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаЗначенийПоказателейКотлы.ЗначениеПоказателя КАК ЗначениеПоказателя,
		|	НастройкаЗначенийПоказателейКотлы.Синоним КАК Синоним,
		|	НастройкаЗначенийПоказателейКотлы.ТипЗначения КАК ТипЗначения
		|ИЗ
		|	РегистрСведений.НастройкаЗначенийПоказателейКотлы КАК НастройкаЗначенийПоказателейКотлы
		|ГДЕ
		|	НастройкаЗначенийПоказателейКотлы.Организация = &Организация";
