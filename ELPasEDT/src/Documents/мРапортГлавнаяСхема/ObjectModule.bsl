...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ШаблонРапортГлавнаяСхема") Тогда
		...
		Для Каждого ТекСтр Из ДанныеЗаполнения.ПоказателиШапки Цикл
			НовСтр = ПоказателиШапки.Добавить();
		...
		Для Каждого ТекСтр Из ДанныеЗаполнения.ЗначенияПоказателей Цикл
			...
			ЗаполнитьЗначенияСвойств(НовСтр, ТекСтр);
		КонецЦикла;
		Для Каждого ТекСтр Из ДанныеЗаполнения.ВоздушныеЛинии Цикл
			НовСтр = ВоздушныеЛинии.Добавить();
			ЗаполнитьЗначенияСвойств(НовСтр, ТекСтр);
		КонецЦикла;
		Для Каждого ТекСтр Из ДанныеЗаполнения.СистемыШин Цикл
			НовСтр = СистемыШин.Добавить();
			ЗаполнитьЗначенияСвойств(НовСтр, ТекСтр);
		КонецЦикла;
