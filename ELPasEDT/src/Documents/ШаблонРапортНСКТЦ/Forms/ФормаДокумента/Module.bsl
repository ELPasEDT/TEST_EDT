...
Функция ПолучитьДанныеРегистраНастроек()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаЗначенийПоказателейНСКТЦ.ЗначениеПоказателя КАК ЗначениеПоказателя,
		|	НастройкаЗначенийПоказателейНСКТЦ.Синоним КАК Синоним,
		|	НастройкаЗначенийПоказателейНСКТЦ.ТипЗначения КАК ТипЗначения
		|ИЗ
		|	РегистрСведений.НастройкаЗначенийПоказателейНСКТЦ КАК НастройкаЗначенийПоказателейНСКТЦ
		|ГДЕ
		|	НастройкаЗначенийПоказателейНСКТЦ.Организация = &Организация";
...
Функция ПолучитьДанныеРегистраНастроекШапка()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаЗначенийПоказателейНСКТЦШапка.ЗначениеПоказателя КАК ЗначениеПоказателя,
		|	НастройкаЗначенийПоказателейНСКТЦШапка.Синоним КАК Синоним,
		|	НастройкаЗначенийПоказателейНСКТЦШапка.ТипЗначения КАК ТипЗначения
		|ИЗ
		|	РегистрСведений.НастройкаЗначенийПоказателейНСКТЦШапка КАК НастройкаЗначенийПоказателейНСКТЦШапка
		|ГДЕ
		|	НастройкаЗначенийПоказателейНСКТЦШапка.Организация = &Организация";
