...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	// регистр ПоказателиЧекЛистовПоПодразделениям
	Движения.ПоказателиЧекЛистовПоПодразделениям.Записывать = Истина;
	Для Каждого ТекСтрокаЧекЛист Из ЧекЛист Цикл
		Движение = Движения.ПоказателиЧекЛистовПоПодразделениям.Добавить();
		Движение.Период = Дата;
		Движение.ЧекЛист = ТекСтрокаЧекЛист.Показатель;
