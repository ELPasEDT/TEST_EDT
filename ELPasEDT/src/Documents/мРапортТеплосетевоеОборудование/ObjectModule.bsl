...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ШаблонРапортТеплосетевоеОборудование") Тогда
		...
		Для Каждого ТекСтр Из ДанныеЗаполнения.УровеньВБакахКонденсата Цикл
			НовСтр = УровеньВБакахКонденсата.Добавить();
