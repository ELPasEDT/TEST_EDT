...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПравоДоступа("Изменение", Метаданные.Справочники.ЗаводыИзготовители) Тогда
...
Процедура ИзменениеСсылкиСервер()
	...
	Объект.НаименованиеДополнительное = Объект.СсылкаДляИзменения.НаименованиеДополнительное;
...
Процедура Изменить(Команда)
	...
	Форма = ПолучитьФорму("Справочник.ЗаводыИзготовители.Форма.ФормаЭлемента");
